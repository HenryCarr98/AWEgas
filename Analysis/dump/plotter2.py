...
# plt.figure(figsize=(6,4))
# plt.plot(threads, execution_time, marker="+", linestyle="-", color="red", label="Measured Time",markeredgecolor="k")

# # Plot the Amdahl's Law curve
# plt.plot(threads, theoretical_time, linestyle="--", color="g", label="Amdahl's Law")
